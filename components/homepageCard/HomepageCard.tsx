	...
	return (
		<section className="pt-4 flex items-center justify-center py-8 mx-12 rounded bg-white dark:bg-gray-800">
			<div className="max-w-4xl mx-auto text-center">
				<h2 className="mx-2 text-1xl font-extrabold leading-9 text-white sm:text-2xl sm:leading-10">
					Used by professional and home bakers, everywhere
				</h2>
				<p className="mx-2 mt-2 text-base leading-7 text-white">
					Feel confident in using this selection of tried and true recipes
				</p>
			</div>
			<div className="mx-2 mt-4 text-center sm:max-w-2xl sm:mx-auto sm:grid sm:grid-cols-3 sm:gap-8">
				<div>
